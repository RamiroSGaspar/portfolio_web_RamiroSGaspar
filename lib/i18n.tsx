...
const es: Dictionary = {
  ...
  // Work & Activity
  "work.title": "Trabajo & Actividad",
  "work.subtitle": "Proyectos, experiencias y eventos",
  "work.filter.all": "Todos",
  "work.filter.projects": "Proyectos",
  "work.filter.experiences": "Experiencias",
  "work.filter.events": "Eventos",
  "work.section.projects": "Proyectos",
  "work.section.experiences": "Experiencias",
  "work.section.events": "Eventos",
  "work.section.projects.lead": "Trabajo propio. Lo que estoy construyendo.",
  "work.section.experiences.lead": "Pasantías y trabajos formales.",
  "work.section.events.lead": "Encuentros y networking.",
  "work.empty.projects": "Estoy preparando los primeros proyectos. Mientras tanto, podés ver mi GitHub.",
  "work.empty.experiences": "Sin experiencias bajo este filtro.",
  "work.empty.events": "Sin eventos bajo este filtro.",
  "work.viewMore": "Ver más",
  "work.viewLess": "Ver menos",
  "work.details": "Ver detalles",
  "work.viewGithub": "GitHub",
  "work.viewDemo": "Web",
  "work.viewProject": "Ver proyecto",
  "work.featured": "Destacado",
  "work.status.planning": "En planificación",
  "work.status.in-progress": "En curso",
...
const en: Dictionary = {
  ...
  "work.title": "Work & Activity",
  "work.subtitle": "Projects, experiences and events",
  "work.filter.all": "All",
  "work.filter.projects": "Projects",
  "work.filter.experiences": "Experiences",
  "work.filter.events": "Events",
  "work.section.projects": "Projects",
  "work.section.experiences": "Experiences",
  "work.section.events": "Events",
  "work.section.projects.lead": "Independent work. What I'm building.",
  "work.section.experiences.lead": "Internships and formal roles.",
  "work.section.events.lead": "Meetups and networking.",
  "work.empty.projects": "I'm preparing the first projects. In the meantime, check out my GitHub.",
  "work.empty.experiences": "No experiences under this filter.",
  "work.empty.events": "No events under this filter.",
  "work.viewMore": "Show more",
  "work.viewLess": "Show less",
